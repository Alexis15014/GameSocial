/**
 * perfil_publico.js
 * Inicializa el gráfico donut de estados de colección en el perfil público.
 * Los datos se leen desde los atributos data-* del canvas #graficoEstadosPub.
 */
(function () {
    const canvas = document.getElementById('graficoEstadosPub');
    if (!canvas) return;
